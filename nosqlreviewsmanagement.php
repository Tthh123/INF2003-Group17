...
<html lang="en">
    ...
    <body>
        ...
        <section id="page-header">
            <h2>#Manage Reviews using Mongo</h2>
        </section>
        ...
        <script>
            ...
            function batchInsert(pagetype) {
                // Determine the script to call based on pagetype
                var scriptUrl = '';
                switch (pagetype) {
                    case '1k':
                        scriptUrl = 'mongo1k.php';
                        break;
                    case '10k':
                        scriptUrl = 'mongo10k.php';
                        break;
                    case '50k':
                        scriptUrl = 'mongo50k.php';
                        break;
                    default:
                ...
                $.ajax({
                    url: scriptUrl, // Dynamic URL based on pagetype
                    type: 'POST',
                    beforeSend: function () {
